...
// Dynamically import the PDFDownloader component (which must have a default export).
  ...
  const fetchPatients = async () => {
    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        setError('An unknown error occurred while fetching patients.');
      }
    } finally {
      setLoading(false);
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        setError('An unknown error occurred during form submission.');
      }
    } finally {
      setLoading(false);
    }
  ...
  return (
    <main style={{ padding: '2rem', fontFamily: 'Arial' }}>
      ...
      <form
        ...
        style={{ display: 'flex', flexDirection: 'column', gap: '10px', maxWidth: '400px', marginBottom: '2rem' }}
      >
        ...
        <button
          type="submit"
          disabled={ageError !== null || loading}
          style={{
            padding: '10px',
      ...
      <div style={{ marginBottom: '1rem' }}>
        ...
        {/* Render the dynamically imported PDFDownloader component */}
      ...
      >
        {showData ? 'Hide Entered Data' : 'Show Entered Data'}
      </button>
        ...
        <div style={{ marginTop: '2rem', display: 'flex', flexWrap: 'wrap', gap: '1rem' }}>
          ...
          {entries.map((entry, index) => (
            ...
            >
              ...
              <p>
                <strong>Village:</strong> {entry.village}
              </p>
              <button
